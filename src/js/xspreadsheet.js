!function(t) {
    ...
    var d = function() {
        ...
        return e = t, r = [{
            ...
            key: "includes",
            value: function() {
                for (var t = 0, e = 0, n = arguments.length, r = new Array(n), i = 0; i < n; i++)
                    r[i] = arguments[i];
                if (1 === r.length) {
                    var o = f(r[0]),
                        a = p(o, 2);
    ...
    var D = {
        ...
        rangeSum: function(t, e, n) {
            for (var r = 0, i = t; i < e; i += 1)
                r += n(i);
            return r
        },
        rangeReduceIf: function(t, e, n, r, i, o) {
            for (var a = n, l = r, c = t; c < e && !(a > i); c += 1)
                a += l = o(c);
            return [c, a - l, l]
        },
                            ...
                            if (this._[x].cells && this._[x].cells[E])
                                for (var j = u; j <= f; j += d)
                                    for (var _ = s; _ <= h; _ += b) {
                                        var C = j + (x - o),
                                            T = _ + (E - a),
                                            P = D.cloneDeep(this._[x].cells[E]);
    ...
    function V(t, e) {
        if (e && e[N])
            for (var n = e[N], r = t.split("."), i = 0; i < r.length; i += 1) {
                var o = n[r[i]];
                if (i === r.length - 1)
                    return o;
                if (!o)
        ...
        return e = t, (n = [{
            ...
            value: function(t) {
                ...
                if ($[i] && !$[i].test(t))
                    return X(!1, "notMatch");
                if ("list" === i)
                    return X(this.values().includes(t), "notIn");
                if (n) {
                    ...
                    if ("eq" === n)
                        return X(o === this.parseValue(r), "equal", r);
                    if ("neq" === n)
                        return X(o !== this.parseValue(r), "notEqual", r);
                    if ("lt" === n)
                        return X(o < this.parseValue(r), "lessThan", r);
                    if ("lte" === n)
                        return X(o <= this.parseValue(r), "lessThanEqual", r);
                    if ("gt" === n)
                        return X(o > this.parseValue(r), "greaterThan", r);
                    if ("gte" === n)
                        return X(o >= this.parseValue(r), "greaterThanEqual", r)
                }
                return [!0]
            }
            ...
            return Q(t, [{
                ...
                value: function(t, e, n) {
                    var r = this.get(t, e),
                        ...
                        o = this.errors;
                    if (null !== r) {
                        var a = J(r.validator.validate(n), 2),
                            l = a[0],
                            c = a[1];
    ...
    function ut(t, e, n) {
        var r = this.styles,
            ...
            o = {};
        void 0 !== i.style && (o = D.cloneDeep(r[i.style])), Object.assign(o, {
            border: n
    ...
    var st = function() {
        ...
        return e = t, (n = [{
                    ...
                    if ("merge" === t)
                            ...
                            if (y || "inside" !== n && "horizontal" !== n && "vertical" !== n)
                                if ("outside" !== n || y) {
                                    if ("none" === n)
                                        ...
                                        for (var p = s; p <= h; p += 1)
                                            "top" === n && (ut.call(this, u, p, {
                                                top: [r, i]
                                            }), p += l.getCellMerge(u, p)[1]), "bottom" === n && (ut.call(this, f, p, {
                                                bottom: [r, i]
                                            }), p += l.getCellMerge(f, p)[1]);
                                    else if ("left" === n || "right" === n)
                                        for (var v = u; v <= f; v += 1)
                                            "left" === n && (ut.call(this, v, s, {
                                                left: [r, i]
                                            }), v += l.getCellMerge(v, s)[0]), "right" === n && (ut.call(this, v, h, {
                                                right: [r, i]
                                            }), v += l.getCellMerge(v, h)[0])
                                } else
                                    ut.call(this, u, s, {
                                        top: [r, i],
                                        bottom: [r, i],
                        ...
                        r.range.each(function(r, a) {
                            var l = o.getCellOrNew(r, a),
                                c = {};
                            if (void 0 !== l.style && (c = D.cloneDeep(i[l.style])), "format" === t)
                                ...
                                "strike" !== t && "textwrap" !== t && "underline" !== t && "align" !== t && "valign" !== t && "color" !== t && "bgcolor" !== t || (c[t] = e, l.style = n.addStyle(c))
                        })
                })
            }
        }, {
                ...
                var n = this.scroll,
                    ...
                    a = function(t, e) {
                        var n = this.rows,
                            ...
                            i = n.height;
                        r + n.height < t && (i -= e);
                        for (var o = this.exceptRowSet, a = 0, l = i, c = n.height; a < n.len && !(l > t); a += 1)
            ...
            key: "rowEach",
            value: function(t, e, n) {
                for (var r = 0, i = this.rows, o = this.exceptRowSet, a = nt(o), l = 0, c = 0; c < a.length; c += 1)
                    a[c] < t && (l += 1);
                for (var u = t + l; u <= e + l; u += 1)
                    if (o.has(u))
                        l += 1;
                    else {
                        var s = i.getHeight(u);
                        if (n(u, r, s), (r += s) > this.viewHeight())
                            break
                    }
            }
        }, {
            ...
            value: function(t) {
                var e = this;
                return Object.keys(t).forEach(function(n) {
                    if ("merges" === n || "rows" === n || "cols" === n || "validations" === n)
                        e[n].setData(t[n]);
                    else if ("freeze" === n) {
                        var r = it(f(t[n]), 2),
                            i = r[0],
    ...
    var kt = function() {
        function t(e) {
            ...
            !function(t, e) {
                if (!(t instanceof e))
                    throw new TypeError("Cannot call a class as a function")
            }(this, t), this.vertical = e, this.moveFn = null, this.el = a("div", "".concat(bt, "-scrollbar ").concat(e ? "vertical" : "horizontal")).child(this.contentEl = a("div", "")).on("mousemove.stop", function() {}).on("scroll.stop", function(t) {
                var e = t.target,
                    r = e.scrollTop,
                    i = e.scrollLeft;
            ...
            value: function(t, e) {
                if (-1 !== t || -1 !== e) {
                    var n = this.range,
                        ...
                        f = a - e;
                    if (i - e > 0)
                        this.arange = new d(r, c, o, i - 1);
                    else if (u > 0)
                        this.arange = new d(l, i, r - 1, a);
                    else if (f < 0)
                        this.arange = new d(r, a + 1, o, c);
                    else {
                        if (!(s < 0))
        ...
        return e = t, (n = [{
            ...
            value: function() {
                var t,
                    ...
                    i = this.bodyEl,
                    o = function(t, e, n) {
                        for (var r = new Date(t, e, 1, 23, 59, 59), i = [[], [], [], [], [], []], o = 0; o < 6; o += 1)
                            for (var a = 0; a < 7; a += 1) {
                                var l = Gt(r, 7 * o + a),
                                    c = l.getMonth() !== e,
    ...
    var oe = function() {
        function t(e, n, r) {
            ...
            }), this.textlineEl = a("div", "textline"), this.suggest.el, this.datepicker.el).on("mousemove.stop", function() {}).on("mousedown.stop", function() {}), this.el = a("div", "".concat(bt, "-editor")).child(this.areaEl).hide(), this.suggest.bindInputEvents(this.textEl), this.areaOffset = null, this.freeze = {
                w: 0,
                h: 0
    ...
    var ce = [{
        ...
        key: "delete-row",
        title: B("contextmenu.deleteRow")
    }, {
        key: "delete-column",
        title: B("contextmenu.deleteColumn")
    }, {
        key: "delete-cell-text",
        title: B("contextmenu.deleteCellText")
    }, {
        key: "divider"
    }, {
        key: "validation",
    ...
    var se = function() {
            function t(e) {
                ...
                !function(t, e) {
                    if (!(t instanceof e))
                        throw new TypeError("Cannot call a class as a function")
                }(this, t), this.el = (n = a("div", "".concat(bt, "-contextmenu"))).children.apply(n, ae(ue.call(this))).hide(), this.viewFn = e, this.itemClick = function() {}, this.isHide = r
            }
            var e,
                n,
                r;
                ...
                value: function(t, e) {
                    if (!this.isHide) {
                        var n = this.el,
                            ...
                            l = e,
                            c = t;
                        a.height - e <= i && (l -= i), a.width - t <= o && (c -= o), n.offset({
                            left: c,
                            top: l
                        }), pt(n)
                    }
                ...
                if (" " !== c)
                    if (c >= "a" && c <= "z")
                        ...
                        if ("(" !== c && r.length > 0 && n.push(r.join("")), ")" === c) {
                            ...
                            if (2 === i)
                                try {
                                    for (var s = ye(f(n.pop()), 2), y = s[0], p = s[1], v = ye(f(n.pop()), 2), d = v[0], b = v[1], g = 0, m = d; m <= y; m += 1)
                                        for (var w = b; w <= p; w += 1)
                                            n.push(h(m, w)), g += 1;
                                    n.push([u, g])
                                } catch (t) {}
        ...
        de = function(t, e, n, r) {
            for (var i = [], o = 0; o < t.length; o += 1) {
                ...
                if ("+" === a) {
                    ...
                    i.push(Number(i.pop()) * Number(i.pop()));
                else if ("/" === a) {
                    var s = i.pop();
                    ...
                    for (var y = ye(a, 2), p = y[0], v = y[1], d = [], b = 0; b < v; b += 1)
                        d.push(i.pop());
    ...
    var je = function(t) {
        ...
        _e = function(t) {
            if (/^(-?\d*.?\d*)$/.test(t)) {
                var e = xe(Number(t).toFixed(2).toString().split("\\.")),
                    n = e[0],
                    r = e.slice(1);
            ...
            value: function(t, e) {
                ...
                if (r && h > e.innerWidth()) {
                    for (var d = {
                        ...
                        d.len >= e.innerWidth() && (this.fillText(t.substring(d.start, b), f, v), u && He.call(this, "strike", f, v, o, a, l.size, d.len), s && He.call(this, "underline", f, v, o, a, l.size, d.len), v += l.size + 2, d.len = 0, d.start = b), d.len += i.measureText(t[b]).width;
                    ...
                    this.fillText(t, f, v), u && He.call(this, "strike", f, v, o, a, l.size, h), s && He.call(this, "underline", f, v, o, a, l.size, h);
    ...
    function Xe(t, e) {
        ...
        var a = r.getCell(o, e);
        if (null !== a) {
            var l = r.getCellStyleOrDefault(o, e),
                c = $e.call(this, t, e);
    ...
    function Ke(t, e, n, r, i) {
        ...
        var c = l.exceptRowSet,
            u = l.exceptRowTotalHeight(t.sri, t.eri);
    ...
    var vn = function(t) {
        function e(t, n, r, i) {
            ...
            !function(t, e) {
                if (!(t instanceof e))
                    throw new TypeError("Cannot call a class as a function")
            }(this, e), (l = hn(this, yn(e).call(this, "div", "".concat(bt, "-dropdown ").concat(i)))).title = t, l.change = function() {}, "string" == typeof t ? l.title = a("div", "".concat(bt, "-dropdown-title")).child(t) : r && l.title.addClass("arrow-left");
            for (var c = arguments.length, u = new Array(c > 4 ? c - 4 : 0), s = 4; s < c; s++)
                u[s - 4] = arguments[s];
    ...
    var Er = function(t) {
        function e(t, n) {
            ...
            var i = new Xt(t).css("height", "16px").css("border-bottom", "3px solid ".concat(n)),
                o = new mr;
    ...
    var Ar = [["thin", '<svg xmlns="http://www.w3.org/2000/svg" width="50" height="1" style="user-select: none;"><line x1="0" y1="0.5" x2="50" y2="0.5" stroke-width="1" stroke="black" style="user-select: none;"></line></svg>'], ["medium", '<svg xmlns="http://www.w3.org/2000/svg" width="50" height="2" style="user-select: none;"><line x1="0" y1="1.0" x2="50" y2="1.0" stroke-width="2" stroke="black" style="user-select: none;"></line></svg>'], ["thick", '<svg xmlns="http://www.w3.org/2000/svg" width="50" height="3" style="user-select: none;"><line x1="0" y1="1.5" x2="50" y2="1.5" stroke-width="3" stroke="black" style="user-select: none;"></line></svg>'], ["dashed", '<svg xmlns="http://www.w3.org/2000/svg" width="50" height="1" style="user-select: none;"><line x1="0" y1="0.5" x2="50" y2="0.5" stroke-width="1" stroke="black" stroke-dasharray="2" style="user-select: none;"></line></svg>'], ["dotted", '<svg xmlns="http://www.w3.org/2000/svg" width="50" height="1" style="user-select: none;"><line x1="0" y1="0.5" x2="50" y2="0.5" stroke-width="1" stroke="black" stroke-dasharray="1" style="user-select: none;"></line></svg>']],
        Rr = function(t) {
            function e(t) {
                ...
                var i = new Xt("line-type"),
                    o = 0,
                    l = Ar.map(function(e, n) {
    ...
    var Wr = function t() {
        ...
        !function(t, e) {
            if (!(t instanceof e))
                throw new TypeError("Cannot call a class as a function")
        }(this, t), this.color = "#000", this.style = "thin", this.mode = "all", this.change = function() {}, this.ddColor = new Er("line-color", this.color), this.ddColor.change = function(t) {
            r.color = t
        ...
        return function(t, e) {
            ...
            value: function(t) {
                for (var e = 0; e < Ce.length; e += 1)
                    Ce[e].key === t && this.title.html(Ce[e].title);
                this.hide()
            }
    ...
    var ta = function(t) {
            function e() {
                var t;
                Ko(this, e);
                var n = new Xt("ellipsis"),
                    r = a("div", "".concat(bt, "-toolbar-more"));
    ...
    var fa = function() {
        function t(e, n) {
            ...
            !function(t, e) {
                if (!(t instanceof e))
                    throw new TypeError("Cannot call a class as a function")
            }(this, t), this.vchange = function() {}, this.el = a("div", "".concat(bt, "-form-input")), this.input = a("input", "").css("width", e).on("input", function(t) {
                return r.vchange(t)
    ...
    var ya = function() {
        function t(e, n, r) {
            ...
            !function(t, e) {
                if (!(t instanceof e))
                    throw new TypeError("Cannot call a class as a function")
            }(this, t), this.key = e, this.getTitle = o, this.vchange = function() {}, this.el = a("div", "".concat(bt, "-form-select")), this.suggest = new qt(n.map(function(t) {
                return {
                    key: t,
                    title: i.getTitle(t)
                }
            ...
            return e = t, (n = [{
                ...
                value: function() {
                    ...
                    if (e.required && /^\s*$/.test(i))
                        return n.html(q("validation.required")), r.addClass("error"), !1;
                    if ((e.type || e.pattern) && !(e.pattern || va[e.type]).test(i))
                        return n.html(q("validation.notMatch")), r.addClass("error"), !1;
        ...
        Ca = function(t) {
            function e() {
                ...
                var n = new da(new ya("cell", ["cell"], "100%", function(t) {
                        ...
                        required: !0
                    }, "".concat(q("dataValidation.range"), ":"), _a),
                    ...
                    i = new da(new ya("list", ["list", "number", "date", "phone", "email"], "100%", function(t) {
                        ...
                        required: !0
                    }, "".concat(q("dataValidation.criteria"), ":"), _a),
                    ...
                    l = new da(new fa("70px", "10"), {
                        required: !0
                    }).hide(),
                    c = new da(new fa("70px", "100"), {
                        required: !0,
                        type: "number"
                    }).hide(),
                    u = new da(new fa("120px", "a,b,c"), {
                        required: !0
                    }),
                    s = new da(new fa("70px", "10"), {
                        required: !0,
                        type: "number"
                    }).hide();
                ...
                }))]))).mf = n, t.rf = r, t.cf = i, t.of = o, t.minvf = l, t.maxvf = c, t.vf = s, t.svf = u, t.change = function() {}, t
            }
            var n,
                r,
                i;
    ...
    function za(t, e) {
        var n = a("div", "".concat(bt, "-toast")),
            r = a("div", "".concat(bt, "-dimmer active"));
    ...
    function Ya(t) {
        var e = this,
            ...
            a = t.offsetX,
            l = t.offsetY,
            c = t.target.className === "".concat(bt, "-selector-corner"),
            u = r.getCellRectByXY(a, l),
            s = u.left,
            f = u.top,
            h = u.width,
            y = u.height,
        ...
        if (d.includes(p, v) && s + h - 20 < a && f + y - 20 < l) {
            ...
            return o.set(v, b, d.getFilter(v), d.getSort(v)), void o.setOffset({
                left: s,
                top: f + y + 2
            })
        }
    ...
    function Za(t, e) {
        ...
        if ("undo" === t)
            ...
            !0 === e ? Ba.call(this) : qa.call(this);
        else if ("clearformat" === t)
            Ja.call(this, "delete-cell-format");
        else if ("link" === t)
            ;
        else if ("chart" === t)
            ;
            ...
            n.setSelectedCellAttr(t, e), "formula" !== t || n.selector.multiple() || Xa.call(this), Va.call(this)
    }
    function Ga() {
        var t,
            e,
            ...
            c = this.rowResizer,
            u = this.colResizer,
            s = this.verticalScrollbar,
            f = this.horizontalScrollbar,
            h = this.editor,
            y = this.contextMenu,
            p = this.data,
            v = this.toolbar,
            d = this.modalValidation,
            b = this.sortFilter;
        l.on("mousemove", function(t) {
            (function(t) {
                if (0 === t.buttons && t.target.className !== "".concat(bt, "-resizer-hover")) {
                    ...
                    s.ri >= 0 && -1 === s.ci ? (s.width = c.indexWidth, r.show(s, {
                        width: u.width
                    })) : r.hide(), -1 === s.ri && s.ci >= 0 ? (s.height = l.height, i.show(s, {
                        height: u.height
                    })) : i.hide()
                }
            }).call(a, t)
            ...
            (function(t) {
                ...
                if (t.detail && (i = 40 * t.detail), i > 0) {
                    var a = n.scroll.ri + 1;
                    a < o.len && e.move({
                        top: r + o.getHeight(a) - 1
                    })
                } else {
                    var l = n.scroll.ri - 1;
                    l >= 0 && e.move({
                        top: 0 === l ? 0 : r - o.getHeight(l)
                    })
                }
            }).call(a, t)
        }), t = l.el, n = (e = {
